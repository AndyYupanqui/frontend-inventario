...
import { VerificarComprobanteComponent } from './components/verificar-comprobante/verificar-comprobante.component';
...
const appRoutes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'verificar-comprobante', component: VerificarComprobanteComponent, canActivate: [AuthGuard] }
